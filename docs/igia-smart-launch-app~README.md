---
id: igia-smart-launch-app~README
title: igia-platform / igia-smart-launch-app
sidebar_label: README
---
<!-- BEGIN adding docusaurus links -->

A web application that enables patient selection during SMART app standalone launch. Works with igia-keycloak component to provide SMART launch context support.<br>
...
This application was generated using JHipster 5.7.1, you can find documentation and help at [https://www.jhipster.tech/documentation-archive/v5.7.1/](https://www.jhipster.tech/documentation-archive/v5.7.1/).
...
You will only need to run this command when dependencies change in [package.json](https://github.com/igia/igia-smart-launch-app/blob/master/package.json).
...
specifying a newer version in [package.json](https://github.com/igia/igia-smart-launch-app/blob/master/package.json). You can also run `npm update` and `npm install` to manage dependencies.
...
To optimize the igiasmartlaunchapp application for production, run:
...
and can be run by starting Spring Boot in one terminal (`./mvnw spring-boot:run`) and running the tests (`npm run e2e` or `yarn e2e`) in a second one.
...
[jhipster 5.7.1 archive]: https://www.jhipster.tech/documentation-archive/
[doing microservices with jhipster]: https://www.jhipster.tech/microservices-architecture/
[using jhipster in development]: https://www.jhipster.tech/development/#-using-jhipster-in-development
[service discovery and configuration with the jhipster-registry]: https://www.jhipster.tech/jhipster-registry/
[using docker and docker-compose]: https://www.jhipster.tech/docker-compose/#-docker-and-docker-compose
[using jhipster in production]: https://www.jhipster.tech/production/#-using-jhipster-in-production
[running tests page]: https://www.jhipster.tech/running-tests/
[code quality page]: https://www.jhipster.tech/code-quality/#-code-quality
[setting up continuous integration]: https://www.jhipster.tech/setting-up-ci/#-setting-up-continuous-integration
