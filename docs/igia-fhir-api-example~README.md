---
id: igia-fhir-api-example~README
title: igia-platform / igia-fhir-api-example
sidebar_label: FHIR API Example
---
<!-- BEGIN adding docusaurus links -->

Sample Spring Boot based FHIR API facade built using the igia-fhir-autocofigure library.<br>
...
To optimize the igiafhirapiexample application for production, run:
