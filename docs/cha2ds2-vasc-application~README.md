---
id: cha2ds2-vasc-application~README
title: igia-platform / cha2ds2-vasc-application
sidebar_label: Sample App UI
---
<!-- BEGIN adding docusaurus links -->

Vanilla Jhipster sample gateway app, to calculate stoke risk score through UI using cha2ds2-vasc algorithm.<br>
...
To optimize the cha2ds2vascapp application for production, run:
...
Then navigate to [http://localhost:8055](http://localhost:8055) in your browser.
...
UI end-to-end tests are powered by [Protractor][]. They're located in `src/test/javascript/e2e`
and can be run by (`npm run e2e`) command.
